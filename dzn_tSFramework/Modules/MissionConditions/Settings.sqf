...
MissionCondition1 = [ "WIN", "(!alive gunter) && { {_x inArea trfinish} count (call BIS_fnc_listPlayers) > 0}", "объект убит, мы ушли", 30 ];
MissionCondition2 = [ "WIPED", { {alive _x} count (call BIS_fnc_listPlayers) < 1 }, "сдохли", 30 ];
